...
class SEResNet(tf.keras.Model):
    def __init__(self, block_num, num_classes):
...
def se_resnet_50(num_classes):
    return SEResNet(block_num=[3, 4, 6, 3], num_classes=num_classes)


def se_resnet_101(num_classes):
    return SEResNet(block_num=[3, 4, 23, 3], num_classes=num_classes)


def se_resnet_152(num_classes):
    return SEResNet(block_num=[3, 8, 36, 3], num_classes=num_classes)